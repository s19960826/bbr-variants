...
/**
 * \brief Build a set of SendNetDevice objects
 *
 * Normally we eschew multiple inheritance, however, the classes 
 * PcapUserHelperForDevice and AsciiTraceUserHelperForDevice are
 * "mixins".
 */
class SendHelper : public PcapHelperForDevice,
	                   public AsciiTraceHelperForDevice
{
public:
  /**
   * Create a SendHelper to make life easier when creating point to
   * point networks.
   */
  SendHelper ();
  virtual ~SendHelper () {}
   ...
   * SendNetDevice created through SendHelper::Install.
   */
   ...
   *
   * Set these attributes on each ns3::SendNetDevice created
   * by SendHelper::Install
   */
   ...
   * \param value the value of the attribute to set
   *
   * Set these attribute on each ns3::SendChannel created
   * by SendHelper::Install
   */
   ...
   *
   * This method creates a ns3::SendChannel with the
   * attributes configured by SendHelper::SetChannelAttribute,
   * then, for each node in the input container, we create a 
   * ns3::SendNetDevice with the requested attributes, 
   * a queue for this ns3::NetDevice, and associate the resulting 
   * ns3::NetDevice with the ns3::Node and ns3::SendChannel.
   */
