 ...
 */
#ifndef RECV_HELPER_H
#define RECV_HELPER_H
...
/**
 * \brief Build a set of RecvNetDevice objects
 *
 * Normally we eschew multiple inheritance, however, the classes 
 * PcapUserHelperForDevice and AsciiTraceUserHelperForDevice are
 * "mixins".
 */
class RecvHelper : public PcapHelperForDevice,
	                   public AsciiTraceHelperForDevice
{
public:
  /**
   * Create a RecvHelper to make life easier when creating point to
   * point networks.
   */
  RecvHelper ();
  virtual ~RecvHelper () {}
   ...
   * RecvNetDevice created through RecvHelper::Install.
   */
   ...
   *
   * Set these attributes on each ns3::RecvNetDevice created
   * by RecvHelper::Install
   */
   ...
   * \param value the value of the attribute to set
   *
   * Set these attribute on each ns3::RecvChannel created
   * by RecvHelper::Install
   */
   ...
   *
   * This method creates a ns3::RecvChannel with the
   * attributes configured by RecvHelper::SetChannelAttribute,
   * then, for each node in the input container, we create a 
   * ns3::RecvNetDevice with the requested attributes, 
   * a queue for this ns3::NetDevice, and associate the resulting 
   * ns3::NetDevice with the ns3::Node and ns3::RecvChannel.
   */
