...
#ifndef SEND_REMOTE_CHANNEL_H
#define SEND_REMOTE_CHANNEL_H
 ...
 * method and uses an MPI Send operation instead.
 */
class SendRemoteChannel : public SendChannel
{
public:
  /**
   ...
   */
  virtual bool TransmitStart (Ptr<const Packet> p, Ptr<SendNetDevice> src,
                              Time txTime);
};
