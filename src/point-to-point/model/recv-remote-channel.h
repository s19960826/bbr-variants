...
#ifndef RECV_REMOTE_CHANNEL_H
#define RECV_REMOTE_CHANNEL_H
 ...
 * method and uses an MPI Send operation instead.
 */
class RecvRemoteChannel : public RecvChannel
{
public:
  /**
   ...
   */
  virtual bool TransmitStart (Ptr<const Packet> p, Ptr<RecvNetDevice> src,
                              Time txTime);
};
