...
NS_LOG_COMPONENT_DEFINE ("CsmaRecvDevice");

NS_OBJECT_ENSURE_REGISTERED (CsmaRecvDevice);

TypeId
CsmaRecvDevice::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::CsmaRecvDevice")
    .SetParent<NetDevice> ()
    .SetGroupName ("Csma")
    .AddConstructor<CsmaRecvDevice> ()
    .AddAttribute ("Address", 
                   "The MAC address of this device.",
                   Mac48AddressValue (Mac48Address ("ff:ff:ff:ff:ff:ff")),
                   MakeMac48AddressAccessor (&CsmaRecvDevice::m_address),
                   MakeMac48AddressChecker ())
    .AddAttribute ("Mtu", "The MAC-level Maximum Transmission Unit",
                   UintegerValue (DEFAULT_MTU),
                   MakeUintegerAccessor (&CsmaRecvDevice::SetMtu,
                                         &CsmaRecvDevice::GetMtu),
                   MakeUintegerChecker<uint16_t> ())
    .AddAttribute ("EncapsulationMode", 
                   "The link-layer encapsulation type to use.",
                   EnumValue (DIX),
                   MakeEnumAccessor (&CsmaRecvDevice::SetEncapsulationMode),
                   MakeEnumChecker (DIX, "Dix",
                                    LLC, "Llc"))
    .AddAttribute ("SendEnable", 
                   "Enable or disable the transmitter section of the device.",
                   BooleanValue (true),
                   MakeBooleanAccessor (&CsmaRecvDevice::m_sendEnable),
                   MakeBooleanChecker ())
    .AddAttribute ("ReceiveEnable",
                   "Enable or disable the receiver section of the device.",
                   BooleanValue (true),
                   MakeBooleanAccessor (&CsmaRecvDevice::m_receiveEnable),
                   MakeBooleanChecker ())
    .AddAttribute ("ReceiveErrorModel", 
                   "The receiver error model used to simulate packet loss",
                   PointerValue (),
                   MakePointerAccessor (&CsmaRecvDevice::m_receiveErrorModel),
    ...
    .AddAttribute ("TxQueue", 
                   ...
                   PointerValue (),
                   MakePointerAccessor (&CsmaRecvDevice::m_queue),
    ...
    .AddTraceSource ("MacTx", 
                     ...
                     MakeTraceSourceAccessor (&CsmaRecvDevice::m_macTxTrace),
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("MacTxDrop", 
                     "Trace source indicating a packet has been "
                     "dropped by the device before transmission",
                     MakeTraceSourceAccessor (&CsmaRecvDevice::m_macTxDropTrace),
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("MacPromiscRx", 
                     ...
                     MakeTraceSourceAccessor (&CsmaRecvDevice::m_macPromiscRxTrace),
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("MacRx", 
                     ...
                     MakeTraceSourceAccessor (&CsmaRecvDevice::m_macRxTrace),
                     "ns3::Packet::TracedCallback")
#if 0
    ...
    .AddTraceSource ("MacRxDrop", 
                     ...
                     MakeTraceSourceAccessor (&CsmaRecvDevice::m_macRxDropTrace),
                     "ns3::Packet::TracedCallback")
#endif
    .AddTraceSource ("MacTxBackoff", 
                     "Trace source indicating a packet has been "
                     "delayed by the CSMA backoff process",
                     MakeTraceSourceAccessor (&CsmaRecvDevice::m_macTxBackoffTrace),
                     "ns3::Packet::TracedCallback")
    //
    ...
    .AddTraceSource ("PhyTxBegin", 
                     ...
                     MakeTraceSourceAccessor (&CsmaRecvDevice::m_phyTxBeginTrace),
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("PhyTxEnd", 
                     "Trace source indicating a packet has been "
                     "completely transmitted over the channel",
                     MakeTraceSourceAccessor (&CsmaRecvDevice::m_phyTxEndTrace),
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("PhyTxDrop", 
                     "Trace source indicating a packet has been "
                     "dropped by the device during transmission",
                     MakeTraceSourceAccessor (&CsmaRecvDevice::m_phyTxDropTrace),
                     "ns3::Packet::TracedCallback")
#if 0
    // Not currently implemented in this device
    .AddTraceSource ("PhyRxBegin", 
                     ...
                     MakeTraceSourceAccessor (&CsmaRecvDevice::m_phyRxBeginTrace),
                     "ns3::Packet::TracedCallback")
#endif
    .AddTraceSource ("PhyRxEnd", 
                     "Trace source indicating a packet has been "
                     "completely received by the device",
                     MakeTraceSourceAccessor (&CsmaRecvDevice::m_phyRxEndTrace),
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("PhyRxDrop", 
                     "Trace source indicating a packet has been "
                     "dropped by the device during reception",
                     MakeTraceSourceAccessor (&CsmaRecvDevice::m_phyRxDropTrace),
                     "ns3::Packet::TracedCallback")
    //
    ...
    .AddTraceSource ("Sniffer", 
                     ...
                     MakeTraceSourceAccessor (&CsmaRecvDevice::m_snifferTrace),
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("PromiscSniffer", 
                     "Trace source simulating a promiscuous "
                     "packet sniffer attached to the device",
                     MakeTraceSourceAccessor (&CsmaRecvDevice::m_promiscSnifferTrace),
                     "ns3::Packet::TracedCallback")
  ;
  return tid;
}

CsmaRecvDevice::CsmaRecvDevice ()
  : m_linkUp (false)
{
...
void 
CsmaRecvDevice::SetDevController (Ptr<ControlDecider> controller)
{
  dev_controller = controller;
}

void
CsmaRecvDevice::SetEncapsulationMode (enum EncapsulationMode mode)
{
...
CsmaRecvDevice::EncapsulationMode
CsmaRecvDevice::GetEncapsulationMode (void)
{
  NS_LOG_FUNCTION_NOARGS ();
  return m_encapMode;
}
...
bool
CsmaRecvDevice::SetMtu (uint16_t mtu)
{
...
uint16_t
CsmaRecvDevice::GetMtu (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
  return m_mtu;
}
...
void
CsmaRecvDevice::SetSendEnable (bool sendEnable)
{
...
void
CsmaRecvDevice::SetReceiveEnable (bool receiveEnable)
{
...
bool
CsmaRecvDevice::IsSendEnabled (void)
{
  NS_LOG_FUNCTION_NOARGS ();
  return m_sendEnable;
}
...
bool
CsmaRecvDevice::IsReceiveEnabled (void)
{
  NS_LOG_FUNCTION_NOARGS ();
...
void
CsmaRecvDevice::SetInterframeGap (Time t)
{
  NS_LOG_FUNCTION (t);
  m_tInterframeGap = t;
}
...
void
CsmaRecvDevice::SetBackoffParams (Time slotTime, uint32_t minSlots, uint32_t maxSlots, uint32_t ceiling, uint32_t maxRetries)
{
...
void
CsmaRecvDevice::AddHeader (Ptr<Packet> p,   Mac48Address source,  Mac48Address dest,  uint16_t protocolNumber)
{
    ...
    case LLC: 
      {
        ...
        NS_ASSERT_MSG (p->GetSize () <= GetMtu (),
                       "CsmaRecvDevice::AddHeader(): 802.3 Length/Type field with LLC/SNAP: "
                       "length interpretation must not exceed device frame size minus overhead");
      }
      break;
    case ILLEGAL:
    default:
      NS_FATAL_ERROR ("CsmaRecvDevice::AddHeader(): Unknown packet encapsulation mode");
      break;
    }
...
#if 0
bool
CsmaRecvDevice::ProcessHeader (Ptr<Packet> p, uint16_t & param)
{
  ...
  switch (m_encapMode)
    ...
    case ILLEGAL:
    default:
      NS_FATAL_ERROR ("CsmaRecvDevice::ProcessHeader(): Unknown packet encapsulation mode");
      break;
    }
  return true;
}
...
void
CsmaRecvDevice::TransmitStart (void)
{
  NS_LOG_FUNCTION_NOARGS ();
  ...
  //
  NS_ASSERT_MSG (m_currentPkt != 0, "CsmaRecvDevice::TransmitStart(): m_currentPkt not set");
  ...
  if (m_channel->GetState () != IDLE)
    {
      ...
      if (m_backoff.MaxRetriesReached ())
      ...
      else 
        {
          ...
          Simulator::Schedule (backoffTime, &CsmaRecvDevice::TransmitStart, this);
        }
    } 
  else 
    {
      ...
      if (m_channel->TransmitStart (m_currentPkt, m_deviceId) == false)
      ...
      else 
        {
          ...
          Simulator::Schedule (tEvent, &CsmaRecvDevice::TransmitCompleteEvent, this);
        }
    }
}

void
CsmaRecvDevice::TransmitAbort (void)
{
  NS_LOG_FUNCTION_NOARGS ();
  ...
  //
  NS_ASSERT_MSG (m_currentPkt != 0, "CsmaRecvDevice::TransmitAbort(): m_currentPkt zero");
  NS_LOG_LOGIC ("m_currentPkt=" << m_currentPkt);
  ...
  if (m_queue->IsEmpty ())
  ...
  else
    {
      ...
      NS_ASSERT_MSG (packet != 0, "CsmaRecvDevice::TransmitAbort(): IsEmpty false but no Packet on queue?");
      m_currentPkt = packet;
...
void
CsmaRecvDevice::TransmitCompleteEvent (void)
{
  NS_LOG_FUNCTION_NOARGS ();
  ...
  //
  NS_ASSERT_MSG (m_txMachineState == BUSY, "CsmaRecvDevice::transmitCompleteEvent(): Must be BUSY if transmitting");
  ...
  //
  NS_ASSERT_MSG (m_currentPkt != 0, "CsmaRecvDevice::TransmitCompleteEvent(): m_currentPkt zero");
  NS_LOG_LOGIC ("m_currentPkt=" << m_currentPkt);
  NS_LOG_LOGIC ("Pkt UID is " << m_currentPkt->GetUid () << ")");
  ...
  Simulator::Schedule (m_tInterframeGap, &CsmaRecvDevice::TransmitReadyEvent, this);
}

void
CsmaRecvDevice::TransmitReadyEvent (void)
{
  NS_LOG_FUNCTION_NOARGS ();
  ...
  //
  NS_ASSERT_MSG (m_txMachineState == GAP, "CsmaRecvDevice::TransmitReadyEvent(): Must be in interframe gap");
  m_txMachineState = READY;
  ...
  //
  NS_ASSERT_MSG (m_currentPkt == 0, "CsmaRecvDevice::TransmitReadyEvent(): m_currentPkt nonzero");
  ...
  if (m_queue->IsEmpty ())
    ...
    {
      Ptr<Packet> packet = m_queue->Dequeue ();
      NS_ASSERT_MSG (packet != 0, "CsmaRecvDevice::TransmitReadyEvent(): IsEmpty false but no Packet on queue?");
      m_currentPkt = packet;
      m_snifferTrace (m_currentPkt);
      m_promiscSnifferTrace (m_currentPkt);
      TransmitStart ();
...
bool
CsmaRecvDevice::Attach (Ptr<CsmaRecvChannel> ch)
{
...
void
CsmaRecvDevice::SetQueue (Ptr<Queue<Packet> > q)
{
  NS_LOG_FUNCTION (q);
  m_queue = q;
}
...
void
CsmaRecvDevice::SetReceiveErrorModel (Ptr<ErrorModel> em)
{
  NS_LOG_FUNCTION (em);
...
void
CsmaRecvDevice::Receive (Ptr<Packet> packet, Ptr<CsmaRecvDevice> senderDevice)
{
  ...
  //deserilize time tag(GetMilliSeconds())
  TimestampTag timestamp;
  AddressTag addressTag;
  //std::cout << "packet is: " << packet->GetSize() << std::endl;
  if (packet->FindFirstMatchingByteTag (timestamp))
  {
    if (packet->FindFirstMatchingByteTag (addressTag)) 
    {
      Time sd = timestamp.GetTimestamp ();
      Time rv = Simulator::Now();
      uint16_t m_address = addressTag.GetAddress();
      dev_controller->SendTime(m_address, sd.GetMicroSeconds());
      dev_controller->RecvTime(m_address, rv.GetMicroSeconds());


      uint64_t m_count = dev_controller->UpdateCounts(m_address);

      if(m_count%10==0 and m_count>=10)
      {
        std::cout << Now().GetSeconds() << std::endl;
        dev_controller->Breakpoint(m_address, Now().GetMicroSeconds());
        std::vector<double> avg = dev_controller->Avg(m_address);
        dev_controller->SwitchAlg(m_address, avg);
      }

        //flow complete time
        if(packet->GetSize()<1090)
        {
            dev_controller->FlowCompleteTime(m_address, Now().GetMicroSeconds());
        }
...
Ptr<Queue<Packet> >
CsmaRecvDevice::GetQueue (void) const 
{ 
  NS_LOG_FUNCTION_NOARGS ();
  return m_queue;
}
...
void
CsmaRecvDevice::NotifyLinkUp (void)
{
  NS_LOG_FUNCTION_NOARGS ();
  m_linkUp = true;
...
void
CsmaRecvDevice::SetIfIndex (const uint32_t index)
{
...
uint32_t
CsmaRecvDevice::GetIfIndex (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
  return m_ifIndex;
}
...
Ptr<Channel>
CsmaRecvDevice::GetChannel (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
  return m_channel;
}
...
void
CsmaRecvDevice::SetAddress (Address address)
{
  NS_LOG_FUNCTION_NOARGS ();
...
Address
CsmaRecvDevice::GetAddress (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
  return m_address;
}
...
bool
CsmaRecvDevice::IsLinkUp (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
  return m_linkUp;
}
...
void
CsmaRecvDevice::AddLinkChangeCallback (Callback<void> callback)
{
...
bool
CsmaRecvDevice::IsBroadcast (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
  return true;
}
...
Address
CsmaRecvDevice::GetBroadcast (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
...
bool
CsmaRecvDevice::IsMulticast (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
  return true;
}
...
Address
CsmaRecvDevice::GetMulticast (Ipv4Address multicastGroup) const
{
...
bool
CsmaRecvDevice::IsPointToPoint (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
  return false;
}
...
bool
CsmaRecvDevice::IsBridge (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
  return false;
}
...
bool
CsmaRecvDevice::Send (Ptr<Packet> packet,const Address& dest, uint16_t protocolNumber)
{
...
bool
CsmaRecvDevice::SendFrom (Ptr<Packet> packet, const Address& src, const Address& dest, uint16_t protocolNumber)
{
  ...
  if (m_txMachineState == READY) 
    {
      if (m_queue->IsEmpty () == false)
        {
          Ptr<Packet> packet = m_queue->Dequeue ();
          NS_ASSERT_MSG (packet != 0, "CsmaRecvDevice::SendFrom(): IsEmpty false but no Packet on queue?");
          m_currentPkt = packet;
          m_promiscSnifferTrace (m_currentPkt);
          m_snifferTrace (m_currentPkt);
          TransmitStart ();
...
Ptr<Node>
CsmaRecvDevice::GetNode (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
  return m_node;
}
...
void
CsmaRecvDevice::SetNode (Ptr<Node> node)
{
...
bool
CsmaRecvDevice::NeedsArp (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
  return true;
}
...
void
CsmaRecvDevice::SetReceiveCallback (NetDevice::ReceiveCallback cb)
{
  NS_LOG_FUNCTION (&cb);
  m_rxCallback = cb;
}

Address CsmaRecvDevice::GetMulticast (Ipv6Address addr) const
{
...
void
CsmaRecvDevice::SetPromiscReceiveCallback (NetDevice::PromiscReceiveCallback cb)
{
  NS_LOG_FUNCTION (&cb);
...
bool
CsmaRecvDevice::SupportsSendFrom () const
{
  NS_LOG_FUNCTION_NOARGS ();
  return true;
}
...
int64_t
CsmaRecvDevice::AssignStreams (int64_t stream)
{
