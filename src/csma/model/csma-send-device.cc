...
NS_LOG_COMPONENT_DEFINE ("CsmaSendDevice");

NS_OBJECT_ENSURE_REGISTERED (CsmaSendDevice);

TypeId
CsmaSendDevice::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::CsmaSendDevice")
    .SetParent<NetDevice> ()
    .SetGroupName ("Csma")
    .AddConstructor<CsmaSendDevice> ()
    .AddAttribute ("Address", 
                   "The MAC address of this device.",
                   Mac48AddressValue (Mac48Address ("ff:ff:ff:ff:ff:ff")),
                   MakeMac48AddressAccessor (&CsmaSendDevice::m_address),
                   MakeMac48AddressChecker ())
    .AddAttribute ("Mtu", "The MAC-level Maximum Transmission Unit",
                   UintegerValue (DEFAULT_MTU),
                   MakeUintegerAccessor (&CsmaSendDevice::SetMtu,
                                         &CsmaSendDevice::GetMtu),
                   MakeUintegerChecker<uint16_t> ())
    .AddAttribute ("EncapsulationMode", 
                   "The link-layer encapsulation type to use.",
                   EnumValue (DIX),
                   MakeEnumAccessor (&CsmaSendDevice::SetEncapsulationMode),
                   MakeEnumChecker (DIX, "Dix",
                                    LLC, "Llc"))
    .AddAttribute ("SendEnable", 
                   "Enable or disable the transmitter section of the device.",
                   BooleanValue (true),
                   MakeBooleanAccessor (&CsmaSendDevice::m_sendEnable),
                   MakeBooleanChecker ())
    .AddAttribute ("ReceiveEnable",
                   "Enable or disable the receiver section of the device.",
                   BooleanValue (true),
                   MakeBooleanAccessor (&CsmaSendDevice::m_receiveEnable),
                   MakeBooleanChecker ())
    .AddAttribute ("ReceiveErrorModel", 
                   "The receiver error model used to simulate packet loss",
                   PointerValue (),
                   MakePointerAccessor (&CsmaSendDevice::m_receiveErrorModel),
    ...
    .AddAttribute ("TxQueue", 
                   ...
                   PointerValue (),
                   MakePointerAccessor (&CsmaSendDevice::m_queue),
    ...
    .AddTraceSource ("MacTx", 
                     ...
                     MakeTraceSourceAccessor (&CsmaSendDevice::m_macTxTrace),
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("MacTxDrop", 
                     "Trace source indicating a packet has been "
                     "dropped by the device before transmission",
                     MakeTraceSourceAccessor (&CsmaSendDevice::m_macTxDropTrace),
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("MacPromiscRx", 
                     ...
                     MakeTraceSourceAccessor (&CsmaSendDevice::m_macPromiscRxTrace),
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("MacRx", 
                     ...
                     MakeTraceSourceAccessor (&CsmaSendDevice::m_macRxTrace),
                     "ns3::Packet::TracedCallback")
#if 0
    ...
    .AddTraceSource ("MacRxDrop", 
                     ...
                     MakeTraceSourceAccessor (&CsmaSendDevice::m_macRxDropTrace),
                     "ns3::Packet::TracedCallback")
#endif
    .AddTraceSource ("MacTxBackoff", 
                     "Trace source indicating a packet has been "
                     "delayed by the CSMA backoff process",
                     MakeTraceSourceAccessor (&CsmaSendDevice::m_macTxBackoffTrace),
                     "ns3::Packet::TracedCallback")
    //
    ...
    .AddTraceSource ("PhyTxBegin", 
                     ...
                     MakeTraceSourceAccessor (&CsmaSendDevice::m_phyTxBeginTrace),
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("PhyTxEnd", 
                     "Trace source indicating a packet has been "
                     "completely transmitted over the channel",
                     MakeTraceSourceAccessor (&CsmaSendDevice::m_phyTxEndTrace),
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("PhyTxDrop", 
                     "Trace source indicating a packet has been "
                     "dropped by the device during transmission",
                     MakeTraceSourceAccessor (&CsmaSendDevice::m_phyTxDropTrace),
                     "ns3::Packet::TracedCallback")
#if 0
    // Not currently implemented in this device
    .AddTraceSource ("PhyRxBegin", 
                     ...
                     MakeTraceSourceAccessor (&CsmaSendDevice::m_phyRxBeginTrace),
                     "ns3::Packet::TracedCallback")
#endif
    .AddTraceSource ("PhyRxEnd", 
                     "Trace source indicating a packet has been "
                     "completely received by the device",
                     MakeTraceSourceAccessor (&CsmaSendDevice::m_phyRxEndTrace),
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("PhyRxDrop", 
                     "Trace source indicating a packet has been "
                     "dropped by the device during reception",
                     MakeTraceSourceAccessor (&CsmaSendDevice::m_phyRxDropTrace),
                     "ns3::Packet::TracedCallback")
    //
    ...
    .AddTraceSource ("Sniffer", 
                     ...
                     MakeTraceSourceAccessor (&CsmaSendDevice::m_snifferTrace),
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("PromiscSniffer", 
                     "Trace source simulating a promiscuous "
                     "packet sniffer attached to the device",
                     MakeTraceSourceAccessor (&CsmaSendDevice::m_promiscSnifferTrace),
                     "ns3::Packet::TracedCallback")
  ;
  return tid;
}

CsmaSendDevice::CsmaSendDevice ()
  : m_linkUp (false)
{
...
void 
CsmaSendDevice::SetDevController (Ptr<ControlDecider> controller)
{
  dev_controller = controller;
}

void
CsmaSendDevice::SetEncapsulationMode (enum EncapsulationMode mode)
{
...
CsmaSendDevice::EncapsulationMode
CsmaSendDevice::GetEncapsulationMode (void)
{
  NS_LOG_FUNCTION_NOARGS ();
  return m_encapMode;
}
...
bool
CsmaSendDevice::SetMtu (uint16_t mtu)
{
...
uint16_t
CsmaSendDevice::GetMtu (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
  return m_mtu;
}
...
void
CsmaSendDevice::SetSendEnable (bool sendEnable)
{
...
void
CsmaSendDevice::SetReceiveEnable (bool receiveEnable)
{
...
bool
CsmaSendDevice::IsSendEnabled (void)
{
  NS_LOG_FUNCTION_NOARGS ();
  return m_sendEnable;
}
...
bool
CsmaSendDevice::IsReceiveEnabled (void)
{
  NS_LOG_FUNCTION_NOARGS ();
...
void
CsmaSendDevice::SetInterframeGap (Time t)
{
  NS_LOG_FUNCTION (t);
  m_tInterframeGap = t;
}
...
void
CsmaSendDevice::SetBackoffParams (Time slotTime, uint32_t minSlots, uint32_t maxSlots, uint32_t ceiling, uint32_t maxRetries)
{
...
void
CsmaSendDevice::AddHeader (Ptr<Packet> p,   Mac48Address source,  Mac48Address dest,  uint16_t protocolNumber)
{
    ...
    case LLC: 
      {
        ...
        NS_ASSERT_MSG (p->GetSize () <= GetMtu (),
                       "CsmaSendDevice::AddHeader(): 802.3 Length/Type field with LLC/SNAP: "
                       "length interpretation must not exceed device frame size minus overhead");
      }
      break;
    case ILLEGAL:
    default:
      NS_FATAL_ERROR ("CsmaSendDevice::AddHeader(): Unknown packet encapsulation mode");
      break;
    }
...
#if 0
bool
CsmaSendDevice::ProcessHeader (Ptr<Packet> p, uint16_t & param)
{
  ...
  switch (m_encapMode)
    ...
    case ILLEGAL:
    default:
      NS_FATAL_ERROR ("CsmaSendDevice::ProcessHeader(): Unknown packet encapsulation mode");
      break;
    }
  return true;
}
...
void
CsmaSendDevice::TransmitStart (void)
{
  NS_LOG_FUNCTION_NOARGS ();
  ...
  //
  NS_ASSERT_MSG (m_currentPkt != 0, "CsmaSendDevice::TransmitStart(): m_currentPkt not set");
  ...
  if (m_channel->GetState () != IDLE)
    {
      ...
      if (m_backoff.MaxRetriesReached ())
      ...
      else 
        {
          ...
          Simulator::Schedule (backoffTime, &CsmaSendDevice::TransmitStart, this);
        }
    } 
  else 
    {
      ...
      if (m_channel->TransmitStart (m_currentPkt, m_deviceId) == false)
      ...
      else 
        {
          ...
          Simulator::Schedule (tEvent, &CsmaSendDevice::TransmitCompleteEvent, this);
        }
    }
}

void
CsmaSendDevice::TransmitAbort (void)
{
  NS_LOG_FUNCTION_NOARGS ();
  ...
  //
  NS_ASSERT_MSG (m_currentPkt != 0, "CsmaSendDevice::TransmitAbort(): m_currentPkt zero");
  NS_LOG_LOGIC ("m_currentPkt=" << m_currentPkt);
  ...
  if (m_queue->IsEmpty ())
  ...
  else
    {
      ...
      NS_ASSERT_MSG (packet != 0, "CsmaSendDevice::TransmitAbort(): IsEmpty false but no Packet on queue?");
      m_currentPkt = packet;
...
void
CsmaSendDevice::TransmitCompleteEvent (void)
{
  NS_LOG_FUNCTION_NOARGS ();
  ...
  //
  NS_ASSERT_MSG (m_txMachineState == BUSY, "CsmaSendDevice::transmitCompleteEvent(): Must be BUSY if transmitting");
  ...
  //
  NS_ASSERT_MSG (m_currentPkt != 0, "CsmaSendDevice::TransmitCompleteEvent(): m_currentPkt zero");
  NS_LOG_LOGIC ("m_currentPkt=" << m_currentPkt);
  NS_LOG_LOGIC ("Pkt UID is " << m_currentPkt->GetUid () << ")");
  ...
  Simulator::Schedule (m_tInterframeGap, &CsmaSendDevice::TransmitReadyEvent, this);
}

void
CsmaSendDevice::TransmitReadyEvent (void)
{
  NS_LOG_FUNCTION_NOARGS ();
  ...
  //
  NS_ASSERT_MSG (m_txMachineState == GAP, "CsmaSendDevice::TransmitReadyEvent(): Must be in interframe gap");
  m_txMachineState = READY;
  ...
  //
  NS_ASSERT_MSG (m_currentPkt == 0, "CsmaSendDevice::TransmitReadyEvent(): m_currentPkt nonzero");
  ...
  if (m_queue->IsEmpty ())
    ...
    {
      Ptr<Packet> packet = m_queue->Dequeue ();
      NS_ASSERT_MSG (packet != 0, "CsmaSendDevice::TransmitReadyEvent(): IsEmpty false but no Packet on queue?");
      m_currentPkt = packet;
      m_snifferTrace (m_currentPkt);
      m_promiscSnifferTrace (m_currentPkt);
      TransmitStart ();
...
bool
CsmaSendDevice::Attach (Ptr<CsmaSendChannel> ch)
{
...
void
CsmaSendDevice::SetQueue (Ptr<Queue<Packet> > q)
{
  NS_LOG_FUNCTION (q);
  m_queue = q;
}
...
void
CsmaSendDevice::SetReceiveErrorModel (Ptr<ErrorModel> em)
{
  NS_LOG_FUNCTION (em);
...
void
CsmaSendDevice::Receive (Ptr<Packet> packet, Ptr<CsmaSendDevice> senderDevice)
{
...
Ptr<Queue<Packet> >
CsmaSendDevice::GetQueue (void) const 
{ 
  NS_LOG_FUNCTION_NOARGS ();
  return m_queue;
}
...
void
CsmaSendDevice::NotifyLinkUp (void)
{
  NS_LOG_FUNCTION_NOARGS ();
  m_linkUp = true;
...
void
CsmaSendDevice::SetIfIndex (const uint32_t index)
{
...
uint32_t
CsmaSendDevice::GetIfIndex (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
  return m_ifIndex;
}
...
Ptr<Channel>
CsmaSendDevice::GetChannel (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
  return m_channel;
}
...
void
CsmaSendDevice::SetAddress (Address address)
{
  NS_LOG_FUNCTION_NOARGS ();
...
Address
CsmaSendDevice::GetAddress (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
  return m_address;
}
...
bool
CsmaSendDevice::IsLinkUp (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
  return m_linkUp;
}
...
void
CsmaSendDevice::AddLinkChangeCallback (Callback<void> callback)
{
...
bool
CsmaSendDevice::IsBroadcast (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
  return true;
}
...
Address
CsmaSendDevice::GetBroadcast (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
...
bool
CsmaSendDevice::IsMulticast (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
  return true;
}
...
Address
CsmaSendDevice::GetMulticast (Ipv4Address multicastGroup) const
{
...
bool
CsmaSendDevice::IsPointToPoint (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
  return false;
}
...
bool
CsmaSendDevice::IsBridge (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
  return false;
}
...
bool
CsmaSendDevice::Send (Ptr<Packet> packet,const Address& dest, uint16_t protocolNumber)
{
  ...
  if (packet->FindFirstMatchingByteTag (addressTag)) {
        //classify flows
        uint32_t m_tuple = addressTag.GetAddress ();
        ...
        /*
        //get the idvalue and revalue to calculate loss rate
        std::map<uint32_t, std::vector<uint64_t>> idValue=dev_controller->idValue;
        std::map<uint32_t, std::vector<uint64_t>>::iterator iter;
	    iter = idValue.find(m_tuple);
        if(iter == idValue.end())
        {
          dev_controller->IdValue(m_tuple,packet->GetUid());
          dev_controller->IdTime(m_tuple,Now().GetMicroSeconds());
        }
        else
        {
          ...
          {
            if(packet->GetUid()==tmp[i])
            {
              dev_controller->IdValue(m_tuple,packet->GetUid());
              dev_controller->IdTime(m_tuple,Now().GetMicroSeconds());
              dev_controller->ReTime(m_tuple, Now().GetMicroSeconds());
              break;
            }
          }
          if(i==-1)
...
bool
CsmaSendDevice::SendFrom (Ptr<Packet> packet, const Address& src, const Address& dest, uint16_t protocolNumber)
{
  ...
  if (m_txMachineState == READY) 
    {
      if (m_queue->IsEmpty () == false)
        {
          Ptr<Packet> packet = m_queue->Dequeue ();
          NS_ASSERT_MSG (packet != 0, "CsmaSendDevice::SendFrom(): IsEmpty false but no Packet on queue?");
          m_currentPkt = packet;
          m_promiscSnifferTrace (m_currentPkt);
          m_snifferTrace (m_currentPkt);
          TransmitStart ();
...
Ptr<Node>
CsmaSendDevice::GetNode (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
  return m_node;
}
...
void
CsmaSendDevice::SetNode (Ptr<Node> node)
{
...
bool
CsmaSendDevice::NeedsArp (void) const
{
  NS_LOG_FUNCTION_NOARGS ();
  return true;
}
...
void
CsmaSendDevice::SetReceiveCallback (NetDevice::ReceiveCallback cb)
{
  NS_LOG_FUNCTION (&cb);
  m_rxCallback = cb;
}

Address CsmaSendDevice::GetMulticast (Ipv6Address addr) const
{
...
void
CsmaSendDevice::SetPromiscReceiveCallback (NetDevice::PromiscReceiveCallback cb)
{
  NS_LOG_FUNCTION (&cb);
...
bool
CsmaSendDevice::SupportsSendFrom () const
{
  NS_LOG_FUNCTION_NOARGS ();
  return true;
}
...
int64_t
CsmaSendDevice::AssignStreams (int64_t stream)
{
