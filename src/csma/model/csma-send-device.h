...
#ifndef CSMA_SEND_DEVICE_H
#define CSMA_SEND_DEVICE_H

#include <cstring>
#include "ns3/node.h"
#include "ns3/send-backoff.h"
 ...
 */
class CsmaSendDevice : public NetDevice 
{
public:
  ...
  /**
   * Construct a CsmaSendDevice
   *
   * This is the default constructor for a CsmaSendDevice.
   */
  CsmaSendDevice ();

  /**
   * Destroy a CsmaSendDevice
   *
   * This is the destructor for a CsmaSendDevice.
   */
  virtual ~CsmaSendDevice ();
   ...
   *
   * The function Attach is used to add a CsmaSendDevice to a CsmaSendChannel.
   *
   * \see SetDataRate ()
   ...
   */
  bool Attach (Ptr<CsmaSendChannel> ch);

  /**
   * Attach a queue to the CsmaSendDevice.
   *
   * The CsmaSendDevice "owns" a queue.  This queue may be set by higher
  ...
  /**
   * Attach a receive ErrorModel to the CsmaSendDevice.
   *
   * The CsmaSendDevice may optionally include an ErrorModel in
  ...
  /**
   * Receive a packet from a connected CsmaSendChannel.
   *
   * The CsmaSendDevice receives packets from its connected channel
   ...
   * \param sender the CsmaSendDevice that transmitted the packet in the first place
   */
  void Receive (Ptr<Packet> p, Ptr<CsmaSendDevice> sender);
   ...
   *
   */
  void SetEncapsulationMode (CsmaSendDevice::EncapsulationMode mode);
   ...
   */
  CsmaSendDevice::EncapsulationMode  GetEncapsulationMode (void);
...
private:
   ...
   * operator for CsmaSendDevice objects.
   * \param o object to copy
   * \returns the copied object
   */
  CsmaSendDevice &operator = (const CsmaSendDevice &o);

  /**
   * Copy constructor is declared but not implemented.  This disables the
   * copy constructor for CsmaSendDevice objects.
   * \param o object to copy
   */
  CsmaSendDevice (const CsmaSendDevice &o);
   ...
   * the CsmaSendDevice to begin the process of sending a packet
   ...
   *
   * \see CsmaSendChannel::TransmitStart ()
   ...
   *
   * \see CsmaSendChannel::TransmitEnd ()
  ...
  /**
   * The CsmaSendChannel to which this CsmaSendDevice has been
   * attached.
   * \see class CsmaSendChannel
   */
  Ptr<CsmaSendChannel> m_channel;

  /**
   * The Queue which this CsmaSendDevice uses as a packet source.
   * Management of this Queue has been delegated to the CsmaSendDevice
  ...
  /**
   * Default Maximum Transmission Unit (MTU) for the CsmaSendDevice
   */
