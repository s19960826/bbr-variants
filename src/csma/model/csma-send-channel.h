...
#ifndef CSMA_SEND_CHANNEL_H
#define CSMA_SEND_CHANNEL_H
...
class CsmaSendRec {
public:
  Ptr< CsmaSendDevice > devicePtr; //!< Pointer to the net device
   ...
   */
  CsmaSendRec(Ptr< CsmaSendDevice > device);

  /**
   * Copy constructor
   * \param o the object to copy
   */
  CsmaSendRec (CsmaSendRec const &o);
 ...
 */
class CsmaSendChannel : public Channel 
{
public:
  ...
  /**
   * \brief Create a CsmaSendChannel
   */
  CsmaSendChannel ();
  /**
   * \brief Destroy a CsmaSendChannel
   */
  virtual ~CsmaSendChannel ();
   ...
   */
  int32_t Attach (Ptr<CsmaSendDevice> device);
   ...
   * can't be found.
   */
  bool Detach (Ptr<CsmaSendDevice> device);
   ...
   * channel or can't be found.
   */
  bool Reattach (Ptr<CsmaSendDevice> device);
   ...
   * number is needed
   */
  int32_t GetDeviceNum (Ptr<CsmaSendDevice> device);
  ...
  /**
   * \return Get a CsmaSendDevice pointer to a connected network device.
   *
   ...
   * with deviceId i.
   */
  Ptr<CsmaSendDevice> GetCsmaDevice (std::size_t i) const;
...
private:
   ...
   * copy constructor for CsmaSendChannel objects.
   * \param o object to copy
   */
  CsmaSendChannel (CsmaSendChannel const &o);

  /**
   * Operator = is declared but not implemented.  This disables the assignment
   * operator for CsmaSendChannel objects.
   * \param o object to copy
   * \returns the copied object
   */
  CsmaSendChannel &operator = (CsmaSendChannel const &o);
   ...
   */
  std::vector<CsmaSendRec> m_deviceList;
